...
`;function Fx(){const[e,t]=b.useState([]),[n,r]=b.useState(!0),[a,i]=b.useState(null);return b.useEffect(()=>{(async()=>{try{const s=await fetch("https://api.currentsapi.services/v1/latest-news?apiKey=hpqpqY8RkrPRulWKdXP5vHKmtuGu93Mje7KtW20GXMcHJMP1");if(!s.ok)throw new Error("Failed to fetch news articles");const u=await s.json();t(u.news),r(!1)}catch(l){console.error("Error fetching news articles:",l),r(!1),i("Failed to fetch news articles")}})()},[]),v.jsx(Dx,{children:v.jsxs("div",{className:"container",children:[v.jsx("div",{className:"header",children:"Top Headlines"}),n?v.jsx("div",{children:"Loading..."}):a?v.jsxs("div",{children:["Error: ",a]}):e.map((o,l)=>v.jsxs("div",{className:"article",children:[v.jsx("div",{className:"title",children:o.title}),v.jsx("div",{className:"description",children:o.description}),v.jsx("div",{className:"source",children:o.author})]},l))]})})}function Ux(){return v.jsx(v.Fragment,{children:v.jsx(Fx,{})})}function Bx(){return v.jsx("div",{children:v.jsx(Sx,{children:v.jsxs(Kg,{children:[v.jsx(zr,{path:"/",element:v.jsx(mx,{})}),v.jsx(zr,{path:"/wilayah/indonesia",element:v.jsx(jx,{})}),v.jsx(zr,{path:"/wilayah/provinsi",element:v.jsx(Mx,{})}),v.jsx(zr,{path:"/wilayah/about",element:v.jsx(Ux,{})})]})})})}kl.createRoot(document.getElementById("root")).render(v.jsx(yt.StrictMode,{children:v.jsx(n1,{children:v.jsx(Bx,{})})}));
